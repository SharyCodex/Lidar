...
: ${AMENT_CURRENT_PREFIX:="/workspace/src/install/ground_plane_estimation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ground_plane_estimation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ground_plane_estimation/environment/path.sh"
